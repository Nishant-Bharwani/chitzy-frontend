...
const Navbar1 = () => {
    ...
    return (
        <>
            ...
            <div className={`row justify-content-center mx-auto ${styles.desktopView} ${styles.navWrapper}`}>
                <header className={`w-100 col-12 col-md-10 col-lg-8 ${styles.maxWFull}`}>
                    <div className={`d-flex align-items-center ${styles.columns} ${styles.maxWL}`}>
                        ...
                        <div className={`${styles.center}`}>
                            <nav className={`${styles.navigation} d-flex align-items-stretch`}>
                        ...
                        <div className={`d-flex flex-grow-1 align-items-center justify-content-end flex-grow-1 ${styles.right}`}>
                            <Link className={`${styles.signupLink} me-2`}>
                                <span className={`${styles.shape}`}>

                                </span>
                                <span className={`d-flex align-items-center justify-content-center ${styles.slot}`}>
                                    Login
                                </span>
                            </Link>
            ...
            <div className={`row justify-content-center mx-auto ${styles.mobileView} ${styles.navWrapper}`}>
                <header className={`w-100 col-12 col-md-10 col-lg-8 ${styles.maxWFull}`}>
                    <div className={`d-flex align-items-center ${styles.columns} ${styles.maxWL}`}>
                        <div className={`${styles.left}`} style={{ fontSize: '16px' }}>
                            <Link to="/" className='d-inline-block'>
                        ...
                        <div className={`d-flex flex-grow-1 align-items-center justify-content-end flex-grow-1 ${styles.right}`}>
                            <div role='button' className="cursor-pointer" onClick={handleNavbarExpansion}>
                                <div className={`cursor-pointer ${styles.hamburger} ${isNavbarExpanded ? styles.open : ''}`}>
                        ...
                        <div className={`${styles.menuBackground}`} style={{ display: `${isNavbarExpanded ? 'block' : 'none'}` }}></div>

                        <div className={`${styles.mobileNavigationWrapper}`} style={{ display: `${isNavbarExpanded ? 'block' : 'none'}` }}>
                            <div className={`${styles.scrollable}`}>
                                <div className={`${styles.mobileNavigationMenu}`}>
                                    <div className={`${styles.mobileNavItem}`}>
                                        <Link className={`d-flex align-items-center cursor-pointer ${styles.mobileNavLink}`} to="/">
                                            <div className="text">
                                                Home
                                            </div>
                                    ...
                                    <div className={`d-flex flex-column align-items-center justify-content-center ${styles.bottomLinks}`}>
